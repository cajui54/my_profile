...
const projects = [
  {
    image: imgStoque,
    svgResponsive: [<RiComputerLine />],
    title: "Dashboard Stock",
    iconTecno: [
      <BiLogoReact title="React.JS" />,
      <SiRedux title="Redux" />,
    ...
    description:
      "CRUD - Gerenciador de uma distribuídora de bebidas, obs: em desenvolvimento.",
    iconSocial: [
      {
        link: "https://d-kebras-dashboard.vercel.app/",
        svgIcon: <FaGlobe />,
        title: "WebSite",
      },
      {
        link: "https://github.com/cajui54/dashboard_app",
        svgIcon: <FaGithub />,
        title: "Repositório",
      },
    ],
  },
  {
    image: imgBarbershop,
    title: "Barbershop",
    svgResponsive: [<MdOutlinePhoneAndroid />, <RiComputerLine />],
    iconTecno: [
      <BiLogoReact />,
      <TbBrandRedux />,
      <SiStyledcomponents />,
    ...
    iconSocial: [
      {
        link: "https://front-end-barbershop.vercel.app/",
        svgIcon: <FaGlobe />,
        title: "WebSite",
      },
      {
        link: "https://github.com/cajui54/front-end-barbershop",
        svgIcon: <FaGithub />,
        title: "Repositório",
      },
    ],
  },
  {
    ...
    iconSocial: [
      {
        link: "https://movie-star-neon.vercel.app/",
        svgIcon: <FaGlobe />,
        title: "WebSite",
      },
      {
        link: "https://github.com/cajui54/Movie_Star",
        svgIcon: <FaGithub />,
        title: "Repositório",
      },
    ],
  },
  {
    image: imgSocial,
    title: "Rede Social",
    svgResponsive: [<FaGithubSquare />],
    iconTecno: [<BiLogoReact />, <FaNode />, <BiLogoMongodb />],
    description:
      "React Gran desenvolvido no curso React.JS, utilizando arquitetura MVC e Banco de Dado",
    iconSocial: [
  ...
  },
  {
    ...
    iconSocial: [
      {
        link: "https://imc-jks.vercel.app/",
        svgIcon: <FaGlobe />,
        title: "WebSite",
      },
      {
        link: "https://github.com/cajui54/Calculate_IMC",
        svgIcon: <FaGithub />,
        title: "Repositório",
      },
    ],
  },
  {
    ...
    iconSocial: [
      {
        link: "https://simulador-dividendo-fundo-imobiliario-zeta.vercel.app/",
        svgIcon: <FaGlobe />,
        title: "WebSite",
      },
      {
        link: "https://github.com/cajui54/SimuladorDividendoFundoImobiliario",
        svgIcon: <FaGithub />,
        title: "Repositório",
      },
    ],
  },
  {
    ...
    iconTecno: [<AiFillHtml5 />, <PiFileCssBold />, <TbBrandJavascript />],
    description:
      "Gerenciador de usuários , que simula o gerencionamento de usuários",
    iconSocial: [
      {
        link: "https://sistema-gerenciador-usuarios.vercel.app/#",
        svgIcon: <FaGlobe />,
        title: "WebSite",
      },
      {
        link: "https://github.com/cajui54/Sistema-Gerenciador-Usuarios",
        svgIcon: <FaGithub />,
        title: "Repositório",
      },
    ],
