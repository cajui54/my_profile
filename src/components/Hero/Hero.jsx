      ...
      <Style.ProfileContainer>
        ...
        <Style.InfoBio>
            ...
            <Style.SVGIconsContainer>
                <a href='https://wa.me/5511941515753' target='blank' className='revealWhats'>
                    <FaWhatsapp/>
                    <span>What</span>
                </a>

                <a href='https://github.com/cajui54' target='blank' className='revealGitHub'>
                    <FaGithub/>
                    <span>GitHub</span>
                </a>

                <a href='https://www.linkedin.com/in/jacksoncajui/' target='blank' className='revealLinkedin'>
                    <FaLinkedin/>
                    <span>Linkedin</span>
                </a>
